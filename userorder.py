...
q1 = """select cid,fid,img,pctname,disamt,qty from orderlist where cid='%s' """ % (uid)
cur.execute(q1)
red = cur.fetchall()
for i in red:
    print(""" 
            ...
            <h5 style="padding-top: 10px;"><b id="discount">Rs.%s <b></h5>
        <div class="qty">
          
            <h3 style="padding-top: 10px;" id="qty"> Qty : %s</h3>
             </div>
            <h5>Delivered</h5>
           </div>
