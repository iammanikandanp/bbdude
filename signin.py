                ...
                <form enctype="multipart/form-data" method="post">
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="phnum" placeholder="1234567890"
                            name="phnum" required>
                    </div>
...
if submit != None:
    b = """insert into register (uname,email,password,gender,dob,phnum,address,city,state,pincode,img) values ('%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','bb logo.png')""" % (username, email, passwords, gender,dob,phnum, address, city, state, pincode)
    cur.execute(b)
    con.commit()
    ...
    server.quit()
    k="""select id from register where email='%s'"""%(email)
    cur.execute(k)
    you=cur.fetchone()
    print(""" <script>
